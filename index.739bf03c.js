...
document.getElementById("pair").addEventListener("click", async ()=>{
    await (0, _common.pair_device)();
});
document.getElementById("start").addEventListener("click", async ()=>{
    await (0, _common.connect_device)();
});
document.getElementById("disconnect").addEventListener("click", async ()=>{
    await (0, _common.disconnect)();
});
document.querySelector("#test_cmd")?.addEventListener("click", async ()=>{
    const command_output = await (0, _common.godo)("ls /", true);
...
(()=>{
    function popper(event) {
        document.querySelector(".imagepreview").src = event.target.parentElement.querySelector("img").src;
        new _bootstrap.Modal(document.querySelector("#imagemodal")).show();
    }
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["l9Mez","ebWYT"], "ebWYT", "parcelRequire75f2")
